...
export function generateAgreementPdf(info: SigningInfo) {
  ...
  body(
    `5.5. In the event of payment default by ${cn}, the Service Provider shall provide a written notice granting a seven (7) day grace period. Failure to pay within this period allows suspension of Platform access.`,
  );
  body(
