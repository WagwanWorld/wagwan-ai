...
export function generateAgreementPdf(info: SigningInfo) {
  ...
  body(
    '5.7. Upon receipt of all outstanding payments, access shall be reinstated within two (2) business days.',
  );
  ...
  body(
    `12.3. In the event of gross negligence or fraud, ${cn} shall provide written notice within two (2) months. The Service Provider shall be granted a one (1) month rectification period.`,
  );
  ...
  body(
    '15.3. Seat and venue: Bengaluru, Karnataka. Proceedings in English. The arbitral award shall be final and binding.',
  );
