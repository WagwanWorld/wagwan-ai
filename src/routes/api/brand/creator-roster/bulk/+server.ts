...
import { filterRowsAlreadyInBrandRoster } from '$lib/server/marketplace/bulkRosterUpload';
...
export const POST: RequestHandler = async ({ request }) => {
  ...
  const { alreadyInRoster, toProcess } = await filterRowsAlreadyInBrandRoster(sb, brandId, valid);
