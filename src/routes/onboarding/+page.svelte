<script lang="ts">
  ...
  async function finish() {
    ...
    try {
      ...
      // Profile is kept locally; cloud persistence can retry on the next visit.
    }
    ...
    if (wToken && wSub) {
      try {
        ...
        // Creator onboarding can continue; invite claim below will safely no-op without a link.
      }
    }
