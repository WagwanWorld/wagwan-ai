  ...
  async function finish() {
    ...
    if (wToken && wSub) {
      try {
        ...
        // Link invite back to roster + create creator signal after the token/profile link exists.
        ...
        // Creator onboarding can complete even if invite linking is temporarily unavailable.
      }
    }
