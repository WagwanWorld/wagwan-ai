...
-- Inserts are performed by service-role app code. Do not add public insert or
-- roster policies here; service_role bypasses RLS, while anon/authenticated
-- clients should not get direct roster access.
